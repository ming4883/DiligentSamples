...
public:
    ...
    virtual const Char* GetSampleName() const override final { return "KM01_VisibilityBuffer"; }
...
private:
    struct VisibilityBuffer
    {
        ...
        RefCntAutoPtr<ITextureView> m_pIdRTV;
        RefCntAutoPtr<ITextureView> m_pDepthDSV;

        static void Create(IRenderDevice* pDevice, std::shared_ptr<VisibilityBuffer>& VisBuffer, Uint32 W, Uint32 H);
        static TEXTURE_FORMAT GetIdBufferFormat();
        static TEXTURE_FORMAT GetDepthBufferFormat();
    };
